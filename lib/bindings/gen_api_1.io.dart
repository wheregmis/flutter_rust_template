...
class ApiClassOnePlatform extends FlutterRustBridgeBase<ApiClassOneWire> {
  ApiClassOnePlatform(ffi.DynamicLibrary dylib) : super(ApiClassOneWire(dylib));
...
class ApiClassOneWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  ApiClassOneWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  ApiClassOneWire.fromLookup(
